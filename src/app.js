...
const elmntNext = document.getElementById("nextButton")
const elmntPrevious = document.getElementById("previousButton")
...
window.catCycleNext = catCycleNext
...
window.returnCatInfo = returnCatInfo
